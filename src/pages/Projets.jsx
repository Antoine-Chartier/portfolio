    ...
    <div className="pageWrap">
      <div className="clamp">
        <div className="centered">
            ...
            <div>
              <CarteProjet titre="Mini-entrepôts" coverPhoto={theme === "light" ? miniEntrepotsCouleur : miniEntrepotsReversed} priority={true} bgColor={linearBlue} alt={"Mini-entrepôts logo"} lien="https://test-ssg-testing.netlify.app/" technologies="GSAP, Flat file CMS, Figma, Tailwind css" description="Durant mon stage chez Rouge Marketing, j'ai développé des compétences en développement web, notamment à travers l'utilisation de Statamic/Laravel (CMS), GSAP (animations) et Tailwind CSS (styling)" />
              <CarteProjet titre="Groovy Beats" coverPhoto={groovyBeats} alt={"Groovy Beats logo"} bgColor={radialRed} lien="https://groovebeats.netlify.app/" technologies="Framer Motion, React Vite, Firestore" description="À travers ce projet final scolaire j'ai acquis plusieurs nouvelles compétences : base de données NoSQL Firestore, Google Auth, gestion de projet, travail d'équipe" />
              <CarteProjet titre="Portfolio" coverPhoto={portfolio} alt={"Portfolio Antoine logo"} bgColor={linearWhite} lien="https://antoinechartier.com/" technologies="Template, hosting" description="Mon premier portfolio web, créé à partir d'un gabarit et personnalisé pour présenter mes compétences en multimédia/web, hébergé sur antoinechartier.com via GitHub Pages." />
            </div>
        </div>
      </div>
    </div>
